...
const Register = () => {
  ...
  useEffect(() => {
    ...
    console.log(result)
    console.log(user);
    //You could also pass the user regex in the setValidName as ana argument
    setValidName(result);
  },[user])
    ...
    <section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <p id='pwdnote' className={pwdFocus && !validPwd ? "instructions":"offscreen"}>
                ...
                Allowed special characters: <span aria-label='at-symbol'>@</span><span aria-label='hashtag'>#</span><span aria-label='dollar sign'>$</span><span aria-label='percent'>%</span>
            </p>
